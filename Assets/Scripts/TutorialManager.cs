...
public class TutorialManager : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        playerWeapon.OnDoneTutorial += DoneTutorial;
    ...
    {
        playerWeapon.pfx.transform.localEulerAngles = new Vector3(-22, 0.1f, 0);
        ...
        playerMovement.z = playerMovement.transform.position.z;
